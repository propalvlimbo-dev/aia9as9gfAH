-- ============================================================
-- ElytrixAuth | MariaDB schema (общая БД: плагин + Telegram-бот)
-- Выполнить: mysql -u root -p < schema.sql
--
-- Время: везде epoch-секунды (BIGINT), чтобы Java (плагин) и
-- Python (бот) не зависели от таймзон сервера БД.
-- ============================================================
